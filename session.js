...
module.exports = exports = function(db) = {
    ...
    if (false === (this instanceof SessionsDAO)) {
        console.log('Warning: Sessions constructor called without "new" operator');
        return new SessionsDAO(db);
    }
    
    this.start = function (username, callback) {
        "use strict";
    ...
    this.get = function (session_id, callback) {
        "use strict";
    ...
    this.end = function(session_d, callback) {
        "use strict";
